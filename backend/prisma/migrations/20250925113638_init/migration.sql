...
-- AddForeignKey
ALTER TABLE "public"."sweet" ADD CONSTRAINT "sweet_categoryId_fkey" FOREIGN KEY ("categoryId") REFERENCES "public"."category"("id") ON DELETE SET NULL ON UPDATE CASCADE;
